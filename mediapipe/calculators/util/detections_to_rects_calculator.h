...
class DetectionsToRectsCalculator : public CalculatorBase {
 public:
  ...
  absl::Status Process(CalculatorContext* cc) override;
    ...
    constexpr static float kMinFloat = std::numeric_limits<float>::lowest();
    constexpr static float kMaxFloat = std::numeric_limits<float>::max();
 ...
 protected:
  ...
  bool output_zero_rect_for_empty_detections_;
    ...
    constexpr static char kDetectionsTag[] = "DETECTIONS";
...
namespace {
    absl::Status NormRectFromKeyPoints(const LocationData& location_data,
        ...
        float xmin = DetectionsToRectsCalculator::kMaxFloat;
        float ymin = DetectionsToRectsCalculator::kMaxFloat;
        float xmax = DetectionsToRectsCalculator::kMinFloat;
        float ymax = DetectionsToRectsCalculator::kMinFloat;
