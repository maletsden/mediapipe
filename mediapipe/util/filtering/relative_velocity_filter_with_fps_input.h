...
class RelativeVelocityFilterWithFpsInput {
 public:
 ...
 public:
  RelativeVelocityFilterWithFpsInput(size_t window_size, float velocity_scale,
  ...
  RelativeVelocityFilterWithFpsInput(size_t window_size, float velocity_scale)
      : RelativeVelocityFilterWithFpsInput{window_size, velocity_scale,
  ...
  float Apply(absl::Duration timestamp, float value_scale, int fps, float value);
